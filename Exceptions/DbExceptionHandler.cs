...
public sealed class DbExceptionHandler : IExceptionHandler
{
    public async ValueTask<bool> TryHandleAsync(HttpContext ctx, Exception ex, CancellationToken ct)
    {
        ...
        {
            PostgresErrorCodes.UniqueViolation => (StatusCodes.Status409Conflict, "Запись с такими данными уже существует"),
            PostgresErrorCodes.ForeignKeyViolation => (StatusCodes.Status400BadRequest, "Связанная запись не найдена"),
